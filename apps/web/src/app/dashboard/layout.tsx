...
const navigation: Array<{ name: string; href: string; icon: ReactNode }> = [
  { name: 'Overview', href: '/dashboard', icon: <Icon d="M4 5a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm10 0a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 15a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zm10-2a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1h-4a1 1 0 01-1-1v-5z" /> },
  { name: 'Bots', href: '/dashboard/bots', icon: <Icon d="M8 10h.01M16 10h.01M9.5 15.5a3.5 3.5 0 005 0M12 4V2.5M7 6a5 5 0 0110 0v6a5 5 0 01-5 5h0a5 5 0 01-5-5V6z" /> },
  { name: 'Backtests', href: '/dashboard/backtests', icon: <Icon d="M9 17v-4m4 4v-8m4 8V7M5 21h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z" /> },
  { name: 'Orders & Fills', href: '/dashboard/orders', icon: <Icon d="M8 7h12m0 0l-4-4m4 4l-4 4M16 17H4m0 0l4 4m-4-4l4-4" /> },
  { name: 'Exchange', href: '/dashboard/exchange', icon: <Icon d="M3 21h18M6 18V9m4 9V5m4 13v-7m4 7V8" /> },
  { name: 'Balances', href: '/dashboard/balances', icon: <Icon d="M3 10h18M7 15h2m4 0h4M5 6h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2z" /> },
  { name: 'Logs', href: '/dashboard/logs', icon: <Icon d="M4 6h16M4 10h16M4 14h10M4 18h7" /> },
  { name: 'Settings', href: '/dashboard/settings', icon: <Icon d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" /> },
];
    ...
    <div className="min-h-screen bg-deep">
      {killActive && (
        <div className="sticky top-0 z-50 flex items-center justify-center gap-2.5 bg-down/15 border-b border-down/30 backdrop-blur px-4 py-2">
          ...
          <p className="text-xs sm:text-sm font-semibold text-down">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="hidden lg:flex w-64 shrink-0 flex-col border-r border-edge bg-panel/60 min-h-screen sticky top-0">
          <div className="px-5 pt-6 pb-5 border-b border-edge">
            <Link href="/dashboard" aria-label="Wallex Grid Bot home">
              <BrandMark withText />
            </Link>
          </div>
          ...
          <header className="sticky top-0 z-40 border-b border-edge bg-deep/85 backdrop-blur">
            <div className="px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between gap-4">
              ...
              <div className="hidden lg:block text-sm text-ink-faint">
                Precision spot grid trading · Wallex Exchange
              </div>
