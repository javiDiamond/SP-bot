    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Welcome to your Wallex Grid Bot dashboard
        </p>
      </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">Total PnL (Paper)</p>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              ...
              You are currently in dry-run/paper trading mode. No real orders will be placed on Wallex Exchange. 
              To enable live trading, go to Settings and follow the risk acknowledgment process.
            </p>
          </div>
        </div>
      </div>
